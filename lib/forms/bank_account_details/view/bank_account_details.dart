...
import 'package:lesedi/forms/bank_account_details/notifier/bank_account_detail_notifier.dart';
...
//   @override
//   ConsumerState<BankAccountDetails> createState() => _BankAccountDetailsState();
// }
//
// class _BankAccountDetailsState extends ConsumerState<BankAccountDetails> {
//   final bankAccountDetailProvider =
//   ChangeNotifierProvider<BankAccountDetailNotifier>((ref) {
//     return BankAccountDetailNotifier();
//   });
//
//   void initState() {
//     /// TODO: implement initState
//     WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
//       ref.read(bankAccountDetailProvider).init();
//     });
//
//     super.initState();
//   }
...
//     final notifier=ref.watch(bankAccountDetailProvider);
//     return Scaffold(
//       appBar: AppBar(
//         centerTitle: true,
//         leading: IconButton(
...
//                               controller: notifier.bankName[index],
//                               obscureText: false,
...
//                             height: 55,
//                             child: new TextFormField(
//                               controller: notifier.accountNoCon[index],
//                               obscureText: false,
//                               decoration: new InputDecoration(
//                                   enabledBorder: OutlineInputBorder(
//                                     borderSide: BorderSide(
...
//                             height: 55,
//                             child: new TextFormField(
//                               controller: notifier.branchCodeCon[index],
//                               obscureText: false,
//                               decoration: new InputDecoration(
//                                   enabledBorder: OutlineInputBorder(
//                                     borderSide: BorderSide(
...
//                 onPressed: () async {
//                   setState(() {
//                     if (notifier.counter < 3) {
//                       notifier.counter = notifier.counter + 1;
//                     } else {
//                       showToastMessage('You have add only three bank details.');
//                     }
//                     print(notifier.counter);
//                   });
//                 },
//                 child: Text(
//                   "Add More",
...
//
//                               notifier.submitForm(
//                                   notifier.bankName.map((e) => e.text).toList(),
//                                   notifier.accountNoCon.map((e) => e.text).toList(),
//                                   notifier.branchCodeCon.map((e) => e.text).toList(),
//                                 widget.applicant_id,
