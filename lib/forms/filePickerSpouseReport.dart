...
class FilePickerSpouseCreditReport extends StatefulWidget {
  ...
  @override
  _FilePickerSpouseCreditReportState createState() => _FilePickerSpouseCreditReportState();
}

class _FilePickerSpouseCreditReportState extends State<FilePickerSpouseCreditReport> {
  String _fileName;
  String _path;
        ...
        try {
          ...
          if (MyConstants.myConst.internet) {
            ...
            if (response.statusCode == 200) {
              print("Status Code of this Spouse Credit is :" +response.statusCode.toString());
              setState(() {
                _isLoadingSecondary = false;
          ...
          (spouse__certificate != null && spouseCreditList.isEmpty)
            ...
            child: Container(
              ...
              child: ListView(
                  ...
                  children: List.generate(spouse__certificate.length, (index) {
