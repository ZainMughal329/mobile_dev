...
class PersonalInformationB1 extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PersonalInformationB1> createState() => _PersonalInformationB1State();
}
...
//                            autofocus: true,
                          inputFormatters: [notifier.maskFormatter],
                          ...
                          showDialog(
                              ...
                              builder: (context) {
                                return _MyDialog(
                                    ...
                                    selectedCities: notifier.selectedCities == null
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              notifier.selectedCities?.length != 0
                                  ? Row(
                                children: List.generate(notifier.selectedCities?.length??0,
                                        (index) {
                                      return Text(
                                        notifier.selectedCities?[index]??"".toString() + ",",
                                        style: TextStyle(
                                            fontSize: 12,
                                            fontFamily: 'opensans',
                                            color: Color(0xff626A76)),
                                ...
                                children: List.generate(
                                    notifier.serviceLinkedHolder.length, (index) {
                                  return Text(
...
//                alignment: Alignment.bottomRight,
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      notifier.formClicked(previousFormSubmitted: widget.previousFormSubmitted, id: widget.applicant_id,context: context,);
...
//  PersonalInformationB1 extends StatefulWidget {
//   int applicant_id;
//   final Function func;
