...
class DecreeDivorce extends StatefulWidget {
  int applicant_id;
  String image_name;
  DecreeDivorce(this.applicant_id, this.image_name);
  @override
  _DecreeDivorceState createState() => _DecreeDivorceState();
}

class _DecreeDivorceState extends State<DecreeDivorce> {
  String? _fileName;
  String? _path;
  ...
  List<String> decree_id_list = <String>[];
...
//    role = sharedPreferences.getString('role');
    ...
    setState(() {
      decree_id_storage = sharedPreferences.getString('decree_divorce');
    });
  }

  void _filePicker() async {
    await request.ifInternetAvailable();
    decree_id_list = <String>[];
    print('hi');
...
//          showToastMessage('Image Uploading Please wait');
          ...
          FormData formData = new FormData.fromMap({
            ...
            'decree_divorce': await MultipartFile.fromFile(
                file.path,
                filename: "decreeOfDivorce.jpg")
          });
          decree_id_list.add(file.path);
          ...
          if (MyConstants.myConst.internet??false) {
            ...
            if (response.statusCode == 200) {
              ...
              print('data');
              print(jsonResponse['data']['decree_divorce']);
...
//            Navigator.pop(context, true);
                ...
                spouse_id = jsonResponse['data']['decree_divorce'];
                ...
                sharedPreferences.setString("decree_divorce", spouse_id);
...
//          "signature_date": selectedDate,
        ...
        decree_id_list.add(_image!.path);
...
//                        width: 600.0,
          ...
          decree_id_storage != null
              ? Container(
            height: decree_id_storage != null ? 150 : 0,
            child: CachedNetworkImage(
              placeholder: (context, url) => CircularProgressIndicator(),
              imageUrl: decree_id_storage != null
                  ? decree_id_storage
...
//            height: 150,
            ...
            child: ListView(
                ...
                children:
                List.generate(decree_id_list.length, (index) {
                  return Center(
                    child: Image.file(
                      File(decree_id_list[index]),
                      width: 100,
                      fit: BoxFit.cover,
                    ),
                  );
