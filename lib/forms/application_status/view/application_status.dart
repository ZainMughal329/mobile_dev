                ...
                child: Column(
                  children: [
                    ...
                    InputFieldWidget(
                      ...
                      controller: notifier.grossMonthlyController, label: "Gross Monthly Income (R)",textInputType: TextInputType.number,)
                  ],
                ),
              ),
              Container(
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      if (!notifier.isLoading) {
                        notifier.submitForm(notifier.checkBoxValue,widget.previousFormSubmitted,widget.applicant_id,context);
                      }
                    },
                    child: Align(
                      alignment: Alignment.bottomRight,
