...
import 'package:lesedi/forms/declaration/notifier/declaration_notifier.dart';
import 'package:lesedi/forms/declaration/notifier/widgets/get_signature_image_widget.dart';
import 'package:lesedi/forms/declaration/notifier/widgets/get_submit_button_widget.dart';
...
class Declaration extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<Declaration> createState() => _DeclarationState();
}

class _DeclarationState extends ConsumerState<Declaration> {
  final declarationProvider =
      ChangeNotifierProvider<DeclarationNotifier>((ref) {
    return DeclarationNotifier();
  });

  void initState() {
    /// TODO: implement initState
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ref.read(declarationProvider).init();
    });
  ...
  Widget build(BuildContext context) {
    final notifier = ref.watch(declarationProvider);
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          actions: [
                  ...
                  children: <Widget>[
                    Expanded(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                            height: 40,
                            padding: notifier.img.buffer.lengthInBytes == 0
                            ...
                            child: getSignatureImage(
                                notifier.img, notifier.storeSignature)),
                      ),
                    ),
                    Expanded(
                      flex: 6,
